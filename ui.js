...
function toggleLoading(isLoading) {
  if (isLoading) {
    document.querySelector("#srchIcon").removeAttribute("class");
    document
      .querySelector("#srchIcon")
      .setAttribute("class", "fas fa-hourglass-half");
    document.querySelector("#innertxt").innerHTML = "Loading...";
  } else {
    document.querySelector("#srchIcon").setAttribute("class", "fas fa-search");
    document.querySelector("#innertxt").innerHTML = "Search";
  }
}
